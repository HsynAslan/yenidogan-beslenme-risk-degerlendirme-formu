object Form2: TForm2
  ...
  object scrMain: TcxScrollBox
      ...
      object grdpnl3: TGridPanel
        ...
        object grdpnl29: TGridPanel
          ...
          object cxlbl28: TcxLabel
            ...
            Top = 1
            Align = alClient
            Caption = 'DE'#286'ERLEND'#304'RMEY'#304' YAPANIN ADI - SOYADI:  '
            ParentColor = False
            ParentFont = False
            Style.Color = clLightgray
            Style.Font.Charset = DEFAULT_CHARSET
    ...
    object grpGridListe: TcxGroupBox
      ...
      object grdpnl30: TGridPanel
        ...
        ColumnCollection = <
          item
            Value = 79.923273657289000000
          end
          item
            Value = 20.076726342711000000
          end>
        ControlCollection = <
          item
            Column = 0
            Control = dbgrdFormHistory
            Row = 0
          end
          item
            Column = 1
        ...
        object dbgrdFormHistory: TDBGrid
          ...
          Columns = <
            item
              Expanded = False
              FieldName = 'FORM_NO'
              Title.Caption = 'Ge'#231'mi'#351' Form Kay'#305'tlar'#305
              Width = 125
              Visible = True
            end
            item
              Expanded = False
              FieldName = 'ILK_TARIH'
              Title.Caption = 'Form Ba'#351'lang'#305#231' Tarihi'
              Width = 146
              Visible = True
            end
            item
              Expanded = False
              FieldName = 'SON_TARIH'
              Title.Caption = 'Form Biti'#351' Tarihi'
              Width = 162
              Visible = True
            end
            item
              ...
              Title.Caption = 'Hafta Say'#305's'#305
              Width = 136
              Visible = True
            end
            item
  ...
  object qrHafta1: TOraQuery
    ...
    object fltfldHafta1HASTANE_NO: TFloatField
      FieldName = 'HASTANE_NO'
    end
  end
  object qrHafta2: TOraQuery
    ...
    object fltfldHafta2HASTANE_NO: TFloatField
      FieldName = 'HASTANE_NO'
    end
  end
  object qrHafta3: TOraQuery
    ...
    object fltfldHafta3HASTANE_NO: TFloatField
      FieldName = 'HASTANE_NO'
    end
  end
  object qrHafta4: TOraQuery
    ...
    object fltfldHafta4HASTANE_NO: TFloatField
      FieldName = 'HASTANE_NO'
    end
  end
  ...
  object qryPrintForm: TOraQuery
    ...
    SQL.Strings = (
      ...
      '    ) AS RISK_OZET'
      ''
      'FROM HASTANE.HEM_BESLENME_GOMEZ R'
      ''
      '/* '#55357#56633' Hasta */'
